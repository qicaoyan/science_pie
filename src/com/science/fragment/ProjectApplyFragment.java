...
public class ProjectApplyFragment extends Fragment {
    ...
    public ProjectApplyFragment(int type){
...
private void requestData(){
	...
	private void initView()
	{
		...
		if(type == ProjectApplyActivity.PROJ_POINEER)
		{
		}
		...
		//findViewById
//		proj_src_btn = view.findViewById(R.id.proj_src_layout);
//		proj_type_btn = view.findViewById(R.id.proj_type_layout);

		
		proj_list_view = (ListView)view.findViewById(R.id.proj_list_view);
...
//		proj_src_pop_view = activity.getLayoutInflater().inflate(R.layout.common_secondary_pop_view, null);
//		proj_type_pop_view = activity.getLayoutInflater().inflate(R.layout.common_stair_pop_view, null);
//		proj_src_list_view = (ListView) proj_src_pop_view.findViewById(R.id.common_secondary_pop_list);
//	    
//		first_adapter = new ProjSourceAdapter(activity,proj_src_list);
...
//	     
//	     second_adapter = new ProjSourceNextAdapter(activity, proj_src_next_list);
...
//	     proj_type_adapter = new ProjTypeAdapter(activity,proj_type_list);
...
//				View vv = view.findViewById(R.id.proj_src_arrow);
...
//				View vv = view.findViewById(R.id.proj_type_arrow);
//				RotateAnimation rot_anim = new RotateAnimation(180,0,(float) (vv.getWidth()*0.5),(float) (vv.getHeight()*0.5));
//				rot_anim.setFillAfter(true);
//				rot_anim.setDuration(100);
//				vv.startAnimation(rot_anim);
	      ...
	      //设置头部按钮的点击事件
		   OnClickListener onHeaderButtonClickListener = new OnClickListener()
		   {
	        ...
	        proj_src_btn.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					final View vv = view.findViewById(R.id.proj_src_arrow);
					...
					if (proj_src_pop_win.isShowing()) {
						...
						rot_anim.setDuration(100);
						vv.startAnimation(rot_anim);
						proj_src_pop_win.showAsDropDown(view.findViewById(R.id.proj_src_layout));
					}
	        ...
	        proj_type_btn.setOnClickListener(new OnClickListener(){
				...
				public void onClick(View v) {
					// TODO Auto-generated method stub
					final View vv = view.findViewById(R.id.proj_type_arrow);
					...
					if (proj_type_pop_win.isShowing()) {
						...
						rot_anim.setDuration(100);
						vv.startAnimation(rot_anim);
						proj_type_pop_win.showAsDropDown(view.findViewById(R.id.proj_type_layout));
					}
...
//				Log.i("proj_item_url", url);
//				Intent intent = new Intent();//用以传递数据
//				intent.setClass(ProjectExpress.activity, ProjectApplicationContentActivity.class);
